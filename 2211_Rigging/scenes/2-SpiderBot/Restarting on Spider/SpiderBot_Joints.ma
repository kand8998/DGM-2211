...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".tp" -type "double3" -4.1255300000000048 1.2390799999999995 3.727969999999996 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "79350EC1-47D7-E5E4-2940-63899003D98B";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E0AB5010-484F-3EF7-B035-10B65CE072A4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BBBE7429-449E-218C-A2AC-A0BE5E88BF05";
createNode displayLayerManager -n "layerManager";
	rename -uid "523941A1-484B-8116-3780-AFACF74930D2";
	setAttr ".cdl" 1;
	setAttr ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E9505A05-42F3-737F-DA07-778A6B16D798";
